...
// Tag Name
var tagName = 'mj-column-image-text-rtl';
// List of parent tags
var parentTag = ['mj-section'];
...
var ColumnImageTextRTL = (0, _mjmlCore.MJMLElement)(_class = function (_Component) {
  _inherits(ColumnImageTextRTL, _Component);

  function ColumnImageTextRTL() {
    _classCallCheck(this, ColumnImageTextRTL);

    return _possibleConstructorReturn(this, (ColumnImageTextRTL.__proto__ || Object.getPrototypeOf(ColumnImageTextRTL)).apply(this, arguments));
  }

  _createClass(ColumnImageTextRTL, [{
    key: 'renderImage',
...
exports.default = ColumnImageTextRTL;